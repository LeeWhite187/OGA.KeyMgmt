...
dotnet build "./OGA.KeyMgmt_NET5/OGA.KeyMgmt_NET5.csproj" -c DebugLinux --runtime linux-x64 --no-self-contained

dotnet restore "./OGA.KeyMgmt_NET5/OGA.KeyMgmt_NET5.csproj"
dotnet build "./OGA.KeyMgmt_NET5/OGA.KeyMgmt_NET5.csproj" -c DebugWin --runtime win-x64 --no-self-contained

dotnet restore "./OGA.KeyMgmt_NET6/OGA.KeyMgmt_NET6.csproj"
dotnet build "./OGA.KeyMgmt_NET6/OGA.KeyMgmt_NET6.csproj" -c DebugLinux --runtime linux-x64 --no-self-contained

dotnet restore "./OGA.KeyMgmt_NET6/OGA.KeyMgmt_NET6.csproj"
dotnet build "./OGA.KeyMgmt_NET6/OGA.KeyMgmt_NET6.csproj" -c DebugWin --runtime win-x64 --no-self-contained

dotnet restore "./OGA.KeyMgmt_NET7/OGA.KeyMgmt_NET7.csproj"
dotnet build "./OGA.KeyMgmt_NET7/OGA.KeyMgmt_NET7.csproj" -c DebugLinux --runtime linux-x64 --no-self-contained

dotnet restore "./OGA.KeyMgmt_NET7/OGA.KeyMgmt_NET7.csproj"
dotnet build "./OGA.KeyMgmt_NET7/OGA.KeyMgmt_NET7.csproj" -c DebugWin --runtime win-x64 --no-self-contained
